...
/*// Get quantize activation layer according to engine.
template <typename Dtype>
shared_ptr<Layer<Dtype> > GetBinActivLayer(const LayerParameter& param) {

    return shared_ptr<Layer<Dtype> >(new BinActivLayer<Dtype>(param));
}

REGISTER_LAYER_CREATOR(BinActiv, GetBinActivLayer);*/
